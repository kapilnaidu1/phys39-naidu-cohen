...
part3_hbridge_motor.txt
    Records from Part 3 of Module 2: trim pot -> PWM -> BTS7960 H-bridge
    -> DC motor. Contains the computed PWM timebase, the direction
    symmetry test at four fixed knob settings, the speed sweep plateaus
